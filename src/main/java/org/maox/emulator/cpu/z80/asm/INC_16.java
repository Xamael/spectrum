 ...
 * DEC
 * <p>
 * Instrucción de incrementar un dato de 16 bits
 * 
 * @author Alex Orgaz
 * 
 */
public class INC_16 extends Instruction {

	/* CPU espeficica de ejecución */
	Z80 z80;

	/**
	 * Constructor, dependiendo del opCode se realizará el incremento de uno sobre un dato determinado
	 * 
	 * @param source Registro a Incrementar
	 * @throws UnknowInstructionException
	 */
	public INC_16(int source) throws UnknowInstructionException {
		super();
		readMode = source;
		idxReadParam = 1;
		assembly = "INC";
	...
	public byte execute() throws InstructionException, IllegalAddressException {
		...
		short res = (short) (reg + (short) 0x0001);
